...
var _exportNames = {
  ...
  ContractUpdateTransaction: true,
  ExchangeRate: true,
...
var _NetworkName = _interopRequireDefault(require("./NetworkName.cjs"));
